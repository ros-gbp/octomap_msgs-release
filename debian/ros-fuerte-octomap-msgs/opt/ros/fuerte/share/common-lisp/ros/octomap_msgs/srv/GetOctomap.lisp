...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GetOctomap-request>)))
  ...
  "c74335a6bc30ba3766f4f6bcc2364be3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GetOctomap-request)))
  "Returns md5sum for a message object of type 'GetOctomap-request"
  "c74335a6bc30ba3766f4f6bcc2364be3")
...
(cl:defclass <GetOctomap-response> (roslisp-msg-protocol:ros-message)
  ((map
    :reader map
    :initarg :map
    :type octomap_msgs-msg:OctomapBinary
    :initform (cl:make-instance 'octomap_msgs-msg:OctomapBinary)))
)
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetOctomap-response>)))
  ...
  (cl:format cl:nil "octomap_msgs/OctomapBinary map~%~%~%================================================================================~%MSG: octomap_msgs/OctomapBinary~%# A 3D map in binary format, as Octree~%Header header~%int8[] data~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetOctomap-response)))
  "Returns full string definition for message of type 'GetOctomap-response"
  (cl:format cl:nil "octomap_msgs/OctomapBinary map~%~%~%================================================================================~%MSG: octomap_msgs/OctomapBinary~%# A 3D map in binary format, as Octree~%Header header~%int8[] data~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
